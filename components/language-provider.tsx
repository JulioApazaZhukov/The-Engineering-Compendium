...
const translations = {
  en: {
    ...
    "formula.copy": "Copy formula",
    "formula.example": "Example:",
    "formula.notes": "Notes:",
    "formula.copied": "Formula copied to clipboard!",
    "formula.category": "Category",
    "formula.subcategory": "Subcategory",
    // Subcategory translations
    "subcategory.all": "All Subcategories",
    "subcategory.differentiation": "Differentiation",
    "subcategory.integration": "Integration",
    "subcategory.limits": "Limits",
    "subcategory.series": "Series",
    "subcategory.identities": "Identities",
    "subcategory.functions": "Functions",
    "subcategory.equations": "Equations",
    "subcategory.expansions": "Expansions",
    "subcategory.factorization": "Factorization",
    "subcategory.plane": "Plane Geometry",
    "subcategory.solid": "Solid Geometry",
    "subcategory.analytic": "Analytic Geometry",
    "subcategory.descriptive": "Descriptive Statistics",
    "subcategory.probability": "Probability",
    "subcategory.distributions": "Distributions",
    "subcategory.correlation": "Correlation",
    "subcategory.mechanics": "Mechanics",
    "subcategory.electricity": "Electricity",
    "subcategory.electromagnetism": "Electromagnetism",
    "subcategory.relativity": "Relativity",
    "subcategory.thermodynamics": "Thermodynamics",
    "subcategory.fluid_mechanics": "Fluid Mechanics",
    "subcategory.quantum": "Quantum Physics",
    "subcategory.optics": "Optics",
    "subcategory.nuclear": "Nuclear Physics",
    // Newsletter section
    ...
    "footer.description":
      "Your comprehensive resource for engineering education, providing in-depth content on mathematics, physics, and engineering principles.",
  ...
  es: {
    ...
    "formula.copy": "Copiar fórmula",
    "formula.example": "Ejemplo:",
    "formula.notes": "Notas:",
    "formula.copied": "¡Fórmula copiada al portapapeles!",
    "formula.category": "Categoría",
    "formula.subcategory": "Subcategoría",
    // Subcategory translations
    "subcategory.all": "Todas las Subcategorías",
    "subcategory.differentiation": "Diferenciación",
    "subcategory.integration": "Integración",
    "subcategory.limits": "Límites",
    "subcategory.series": "Series",
    "subcategory.identities": "Identidades",
    "subcategory.functions": "Funciones",
    "subcategory.equations": "Ecuaciones",
    "subcategory.expansions": "Expansiones",
    "subcategory.factorization": "Factorización",
    "subcategory.plane": "Geometría Plana",
    "subcategory.solid": "Geometría Sólida",
    "subcategory.analytic": "Geometría Analítica",
    "subcategory.descriptive": "Estadística Descriptiva",
    "subcategory.probability": "Probabilidad",
    "subcategory.distributions": "Distribuciones",
    "subcategory.correlation": "Correlación",
    "subcategory.mechanics": "Mecánica",
    "subcategory.electricity": "Electricidad",
    "subcategory.electromagnetism": "Electromagnetismo",
    "subcategory.relativity": "Relatividad",
    "subcategory.thermodynamics": "Termodinámica",
    "subcategory.fluid_mechanics": "Mecánica de Fluidos",
    "subcategory.quantum": "Física Cuántica",
    "subcategory.optics": "Óptica",
    "subcategory.nuclear": "Física Nuclear",
    // Newsletter section
    ...
    "footer.description":
      "Tu recurso integral para la educación en ingeniería, proporcionando contenido detallado sobre matemáticas, física y principios de ingeniería.",
